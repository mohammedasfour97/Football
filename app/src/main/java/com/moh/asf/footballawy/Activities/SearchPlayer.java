...
public class SearchPlayer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(getplace)) {
                    if (detect.equals("specific")) {
                        ...
                        Intent intent = new Intent(SearchPlayer.this , SearchResultsPlayers.class);
        ...
        my_team.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SearchPlayer.this , MakePlayer.class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SearchPlayer.this , MainActivity.class);
                startActivity(intent);
                SearchPlayer.this.finish();
            }
        });
